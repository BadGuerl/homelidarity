...
function Footer() {
    return (
        <footer className="mt-4 w-100 bottom-0 row justify-content-end">
            <div className="container d-flex justify-content-end p-4">
                ...
                <a className="nav-link text-secondary m-0 p-1" href="https://fundacionlacaixa.org/es/">/ Obra social "laCaixa" </a>

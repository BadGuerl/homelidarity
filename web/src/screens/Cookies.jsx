...
function Cookies() {
    return (
        <div className="login-card">
            ...
            <h4 className="text-secondary mb-4">Política de Cookies</h4>
            <div className="container col-6 border-top">
                <p className="mt-3 text-secondary text-start">El acceso al sitio web puede implicar la utilización de cookies, que son pequeñas
